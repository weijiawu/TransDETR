...
python3 parallel_eval.py \
    ...
    --data_txt_path_train ./datasets/data_path/TextVR.train \
    --data_txt_path_val ./datasets/data_path/TextVR.train \
    --resume ${EXP_DIR}/checkpoint.pth
#     \
#     --show checkpointMOTA27.4_IDF47.9.pth
