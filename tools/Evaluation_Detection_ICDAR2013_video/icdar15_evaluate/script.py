...
def eval_2015(res_folder,gt_folder ,gt_name = 'icdar13_gt.zip'):
...
#         if filename.split("_")[1] not in check:
#             continue
        if os.path.exists(os.path.join(gt_folder, filename)):
...
if __name__=='__main__':
    ...
    # rrc_evaluation_funcs.main_evaluation(None,default_evaluation_params,validate_data,evaluate_method)
    res_folder = "/share/wuweijia/Code/VideoSpotting/MOTR/tools/Evaluation_Detection_ICDAR2013_video/icdar15_evaluate/res"
    gt_folder = "/share/wuweijia/Code/VideoSpotting/MOTR/tools/Evaluation_Detection_ICDAR2013_video/icdar15_evaluate/gt"
