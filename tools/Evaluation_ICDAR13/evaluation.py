...
def parse_args():
    ...
    parser.add_argument('--tests', type=str,default='/share/wuweijia/Code/VideoSpotting/MOTR/tools/Evaluation_ICDAR13/DAVAR_evaluation/pred/end2end_json',
...
#     filter_seqs = seqs[:50]
    ...
    for seq in tqdm(filter_seqs): # tqdm(seqs):
        ...
        result_path = os.path.join(args.tests, (D_seq.split("_")[0]+"_"+D_seq.split("_")[1]+".json").replace("Video","res_video"))
