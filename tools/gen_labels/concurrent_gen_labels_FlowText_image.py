...
#     root = tree.getroot()  # 获取树型结构的根
    ...
    from_label_root = "/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowText/images/train"
    seq_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowText/images/train'
    label_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowText/labels_with_ids/train'
...
def gen_data_path(path,split_train_test="train",data_path_str = "./datasets/data_path/FlowText.train"):
    ...
    for video_name in os.listdir(image_path):
        ...
        for i in range(0,len(frame_list)):
            frame_real_path = "FlowText/images/train/" + video_name + "/{}.jpg".format(str(i).zfill(8)) + "\n"
