...
def gen_data_path(path,split_train_test="train",data_path_str = "./datasets/data_path/VISD.train"):
    ...
    for video_name in os.listdir(image_path):
        ...
        for i in frame_list:
            ...
            frame_real_path = "VISD/images/train/" + video_name + "/{}".format(i) + "\n"
...
# gen_data_path(path = "/mmu-ocr/weijiawu/Data/VideoText/MOTR/VISD")
...
with Pool(max_workers=20) as execute :
    ...
    future_task = [execute.submit(parse,seq) for seq in seqs]
    ...
    for seq in seqs:
        ...
        for a in tqdm(ann_list):
            ...
            label_fpath = osp.join(seq_label_root, a.replace("gt_","").replace("jpg","txt").replace("png","txt"))
