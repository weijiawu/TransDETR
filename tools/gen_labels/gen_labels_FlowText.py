...
#     bboxes = np.reshape(bboxes, (bboxes.shape[0], -1))
    ...
    words_final = []
    for i, (id_one, object_boxe, word) in enumerate(zip(id_S,bboxes_all,words)):
...
#             continue
        ...
        for i in range(0,len(frame_list)):
            ...
            frame_real_path = "FlowTextV2/images/train/" + video_name + "/{}.jpg".format(str(frame_id).zfill(8)) + "\n"
            lines.append(frame_real_path)
    write_lines(data_path_str, lines)  
    

# from_label_root = "/mmu-ocr/weijiawu/Data/VideoText/MOTR/VideoSynthText/images/train"
# seq_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/VideoSynthText/images/train'
...
gen_data_path(path="/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowTextV2")