...
def gen_data_path(path,split_train_test="train",data_path_str = "./datasets/data_path/ICDAR15_Pre.train"):
    ...
    for video_name in os.listdir(image_path):
        ...
        for i in frame_list:
            ...
            frame_real_path = "ICDAR15_Pre/images/train/" + video_name + "/{}".format(i) + "\n"
...
#         seq_height, seq_width = one_imgs["height"], one_imgs["width"]
        ...
        for box in boxs:
            ...
            tid_curr, x / seq_width, y / seq_height, w / seq_width, h / seq_height, rotate)
