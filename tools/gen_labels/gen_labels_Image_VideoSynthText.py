...
def gen_data_path(path,split_train_test="train",data_path_str = "./datasets/data_path/FlowImage.train"):
    ...
    for video_name in os.listdir(image_path):
        ...
        for i in frame_list:
            ...
            frame_real_path = "FlowImage/images/train/" + video_name + "/{}".format(i) + "\n"
            lines.append(frame_real_path)
    write_lines(data_path_str, lines)  
    

from_label_root = "/mmu-ocr/weijiawu/Data/VideoText/MOTR/VideoSynthText_image/train_gt"
seq_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowImage/images/train'
label_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowImage/labels_with_ids/train'
mkdirs(label_root)
seqs = [s for s in os.listdir(seq_root)]

gen_data_path(path = "/mmu-ocr/weijiawu/Data/VideoText/MOTR/FlowImage")
...
#             lines = f.readlines()
#         for line in lines:
#             box = list(map(float, line.rstrip('\n').lstrip('\ufeff').split(',')[:8]))
#             boxs.append(box)
#             words.append(line.rstrip('\n').lstrip('\ufeff').split(',')[-1])
#         one_imgs_path = os.path.join(image_path_frame,a.replace("gt_","").replace("txt","jpg"))
