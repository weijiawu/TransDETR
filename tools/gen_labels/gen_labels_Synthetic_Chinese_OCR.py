...
def gen_data_path(path,split_train_test="train",data_path_str = "./datasets/data_path/Synthetic_Chinese_OCR.train"):
    ...
    for video_name in os.listdir(image_path):
        ...
        for i in frame_list:
            label_path = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/Synthetic_Chinese_OCR/labels_with_ids/train/images/' + i.replace("jpg","txt").replace("png","txt")
            if not os.path.exists(label_path):
                continue
#                 with open(label_path, 'w') as f:
#                     pass
                    
            frame_real_path = "Synthetic_Chinese_OCR/images/train/" + video_name + "/{}".format(i) + "\n"
...
label_root = '/mmu-ocr/weijiawu/Data/VideoText/MOTR/Synthetic_Chinese_OCR/labels_with_ids/train'
mkdirs(label_root)
...
for seq in seqs:
    ...
    for idx,a in tqdm(enumerate(lines)):
        ...
        label_fpath = osp.join(seq_label_root, filename.replace("jpg","txt").replace("png","txt"))
        ...
        tid_curr, x / seq_width, y / seq_height, w / seq_width, h / seq_height, 0, 0, 0, w, h, trans)
